...
export const TRANSLATIONS = {
  en: {
    ...
    card_view_dossier: 'View Full Dossier ➔',
    codex_dossier_breadcrumb: 'Illustrated Codex',
    ...
    codex_dossier_psychology_title: 'Cognitive Trap & Psychological Mechanism',
  ...
  id: {
    ...
    card_view_dossier: 'Lihat Berkas Lengkap ➔',
    codex_dossier_breadcrumb: 'Kodeks Bergambar',
    ...
    codex_dossier_psychology_title: 'Perangkap Kognitif & Mekanisme Psikologis',
  ...
  es: {
    ...
    card_view_dossier: 'Ver Dossier Completo ➔',
    codex_dossier_breadcrumb: 'Códice Ilustrado',
    ...
    codex_dossier_psychology_title: 'Trampa Cognitiva y Mecanismo Psicológico',
  ...
  fr: {
    ...
    card_view_dossier: 'Voir le Dossier Complet ➔',
    codex_dossier_breadcrumb: 'Codex Illustré',
    ...
    codex_dossier_psychology_title: 'Piège Cognitif et Mécanisme Psychologique',
  ...
  zh: {
    ...
    card_view_dossier: '查看完整档案 ➔',
    codex_dossier_breadcrumb: '插图法典',
    ...
    codex_dossier_psychology_title: '认知陷阱与心理机制',
