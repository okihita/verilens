...
export const TRANSLATIONS = {
  en: {
    ...
    hero_cta_primary: 'Start Daily Gauntlet (60s Quick Trial)',
    hero_cta_secondary: 'Explore Fallacy Codex ▾',
    ...
    step1_badge: 'STEP 01',
    step1_title: 'Understand Archetypes',
    step1_desc: 'Master the 12 psychological manipulation and cognitive bias patterns.',
    step1_action: 'Browse Codex ▾',
    step2_badge: 'STEP 02',
    step2_title: 'Train Reflexes',
    step2_desc: 'Triage breaking headlines and crypto lures under timed pressure.',
    step2_action: 'Play Gauntlet (60s)',
    step3_badge: 'STEP 03',
    step3_title: 'Verify Live Claims',
    step3_desc: 'Execute Stanford SIFT lateral reading on articles in <300ms.',
  ...
  id: {
    ...
    hero_cta_primary: 'Mulai Tantangan 60 Detik (Uji Cepat)',
    hero_cta_secondary: 'Jelajahi Kodeks Sesat Pikir ▾',
    ...
    step1_title: 'Pahami Arketipe',
    step1_desc: 'Kuasai 12 pola manipulasi retorika dan bias kognitif.',
    step1_action: 'Buka Kodeks ▾',
    step2_badge: 'LANGKAH 02',
    step2_title: 'Latih Refleks',
    step2_desc: 'Sortir berita viral dan jebakan finansial dalam batas waktu.',
    step2_action: 'Mulai Gauntlet (60s)',
    step3_badge: 'LANGKAH 03',
    step3_title: 'Verifikasi Berita Langsung',
    step3_desc: 'Jalankan pembacaan lateral Stanford SIFT dalam <300ms.',
